				...
				<el-tabs>
					<el-tab-pane label="点餐">
						<el-table :data="tableData" border style="width:100%;" >
							...
							<el-table-column prop="count" label="量" width="50" header-align="center"></el-table-column>
...
<script>
	...
	export default{
		...
		mounted(){
			var orderHeight = document.body.clientHeight || document.documentElement.clientHeight;
